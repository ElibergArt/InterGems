...
<head>
    ...
    <link rel="shortcut icon" href="/img/icon_w.png" type="image/png">
...
<div class="index"> 
        <div class="igems">
            <svg version="1.1" width="42" height="42" viewBox="0 0 1024 1024">
                ...
                <path class="facet-2" fill="#2AD5E5" d="M370.688 385.664l151.84 533.216 130.656-533.216h-282.496z">
                </path>
                <path class="facet-3" fill="#72F2FE" d="M545.632 917.792l412.736-532.128h-254.816l-157.92 532.128z">
                </path>
                ...
                <path class="top-facet-5" fill="#2AD5E5"
                    d="M959.328 350.848l-123.744-211.584-123.808 211.584h247.552z ">
                </path>
            </svg>

<div class="gem_rays_container">
    <div class="green_ray">
        <p></p>
    </div>
    <div class="blue_ray">
...
<div>
    <a href="/index.php"><img class="svglogo" src="img/logo.svg" height="200px" alt=""></a>
</div>

</div>
</div>
<!-- а ща мы ебанем сюда блики от камней!!! -->
